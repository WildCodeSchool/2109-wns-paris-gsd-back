...
var RoleInput_1 = __importDefault(require("./RoleInput/RoleInput"));
var RoleResolver = /** @class */ (function () {
    function RoleResolver() {
    }
    RoleResolver.prototype.getRoles = function () {
    ...
    RoleResolver.prototype.addRole = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var role;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        role = Role_1.default.create(__assign({}, data));
    ...
    __decorate([
        ...
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [RoleInput_1.default]),
        __metadata("design:returntype", Promise)
